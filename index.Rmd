...
* Code
    * Visualization: [ggplot](https://ggplot2.tidyverse.org/index.html)
        ...
        * R markdown: [_part3_visualization.Rmd](_part3_visualization.Rmd) (Load this file in RStudio. Let's take this opportunity to learn about [R Markdown](https://rmarkdown.rstudio.com/lesson-1.html).)
    * Visualization: [tidyquant charting](https://business-science.github.io/tidyquant/articles/TQ04-charting-with-tidyquant.html), [dygraph](https://rstudio.github.io/dygraphs/), and R markdown [flexdashboard](https://rmarkdown.rstudio.com/flexdashboard/)
        ...
        * R markdown: [_time_series_flexboard.Rmd](_time_series_flexboard.Rmd) (Load this file in RStudio; HTML output: [time_series_flexboard.html](time_series_flexboard.html))
